...
public interface InformationBoardRepository extends JpaRepository<InformationBoardEntity, Integer> {
    ...
    @Query(value = "SELECT " +
            ...
            "count(H.user_number) AS informationHeartCount " +
            "FROM information I " +
            "LEFT JOIN information_comment C ON I.information_board_number = C.information_board_number " +
            "LEFT JOIN information_heart H ON I.information_board_number = H.information_board_number " +
            "GROUP BY I.information_board_number " +
    ...
    @Query(value = "SELECT " +
            ...
            "LEFT JOIN information_heart H ON I.information_board_number = H.information_board_number " +
            "GROUP BY I.information_board_number " +
            "ORDER BY informationHeartCount DESC",
            nativeQuery = true)
    ...
    @Query(value = "SELECT " +
            ...
            "LEFT JOIN information_heart H ON I.information_board_number = H.information_board_number " +
            "GROUP BY I.information_board_number " +
            "ORDER BY informationCommentCount DESC",
            nativeQuery = true)
